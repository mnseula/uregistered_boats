        ...
        if (perfpkgpartno === "") {
            ...
            if (typeof stndsMtrx !== 'undefined') {
                $.each(stndsMtrx, function (j) {
                    ...
                    else if (partId === 'S102') { defaultperfpkgid = '2'; }
                    else if (partId === 'S309') { defaultperfpkgid = '12'; }
                    else if (partId === 'S312') { defaultperfpkgid = '16'; }
                    else if (partId === 'S244' || partId === 'S247') { defaultperfpkgid = '11'; }
                });
            }
            ...
            if (defaultperfpkgidonboat === null) {
                defaultperfpkgidonboat = getUdpByPart('568974f2a9d29adf3e5ecfce', perfpkgpartno, 'PerfPkgID');
            }
